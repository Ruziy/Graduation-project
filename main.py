...
def main():
    ...
    # Выбор модели
    if args.model == "yolov8":
        detector = YOLO(r"C:\Users\Alex\Desktop\diplom\Graduation-project\yolov8n-face.pt")
        ...
        path_prototxt = r"C:\Users\Alex\Desktop\diplom\Graduation-project\CAFFE_DNN\deploy.prototxt.txt"
        path_model_weights = r"C:\Users\Alex\Desktop\diplom\Graduation-project\CAFFE_DNN\res10_300x300_ssd_iter_140000.caffemodel"
        net = cv2.dnn.readNetFromCaffe(path_prototxt, path_model_weights)
...
if __name__ == "__main__":
    main()
>>>>>>> 35c28cbf42b84eba0ebb5041d0638e7569921b58
